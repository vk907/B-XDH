...
r=LWE.estimate(params,red_cost_model=MATZOV(nn="list_decoding-naive_quantum"))#quantum
"""
bkw                  :: rop: ≈2^180.9, m: ≈2^166.0, mem: ≈2^160.1, b: 11, t1: 0, t2: 19, ℓ: 10, #cod: 453, #top: 3, #test: 56, tag: coded-bkw
usvp                 :: rop: ≈2^117.0, red: ≈2^117.0, δ: 1.004250, β: 364, d: 1020, tag: usvp
bdd                  :: rop: ≈2^113.9, red: ≈2^113.1, svp: ≈2^112.6, β: 348, η: 384, d: 1023, tag: bdd
dual                 :: rop: ≈2^121.1, mem: ≈2^88.9, m: 512, β: 376, d: 1024, ↻: 1, tag: dual
dual_hybrid          :: rop: ≈2^115.7, red: ≈2^115.6, guess: ≈2^112.7, β: 354, p: 5, ζ: 0, t: 40, β': 366, N: ≈2^75.8, m: 512
"""
